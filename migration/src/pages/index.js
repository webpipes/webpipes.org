...
const IndexPage = () => (
  <Layout>
    ...
    <div className='content mw8 center pv5 relative cf open'>
      <div className='fr-l mt0-l mt6 ph3 w-40-l w-70-ns w-90 center lh-copy'>
        ...
        <ol>
          ...
          <li className='mb2'>
            We want to show what's possible with it without using any custom
            css. <em>It's frickin impressive</em> 😮😅.
          </li>
          <li className='mb2'>
          ...
          <li className='mb2'>
            These tools can serve as starter templates for projects. Tachyons
            makes it really easy to re-use components ♻️ to extend 🚀 these
            templates into full sites or products.
          </li>
          <li className='mb2'>
        ...
        <p>
          Absolutely anything you want! Dissect them with developer tools to
          learn Tachyons, extend them into full sites or turn them into
          something else!
        </p>
        <h2 className='f4 mb0 mt4 db sans-serif'>
        ...
        <p>
          ...
          like responsive menus, sign up forms, ui kits and many more! Send us
          an{' '}
          <a
            className='link white b hover-bg-blue-new'
